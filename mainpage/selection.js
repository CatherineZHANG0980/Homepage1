...
var count_select_box_times = 0;
var my_select_boxes_button = document.getElementById("select_box_times");
function boxes_click_display(){
  count_select_box_times ++;
  if(count_select_box_times % 2 ==0){
    document.querySelectorAll(".box2")[0].style.display = "none";
    document.querySelectorAll(".box2")[1].style.display = "none";
    document.querySelectorAll(".box2")[2].style.display = "none";
    ...
    document.querySelectorAll(".box2")[1].style.display = "block";
    document.querySelectorAll(".box2")[2].style.display = "block";
